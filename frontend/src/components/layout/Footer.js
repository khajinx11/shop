            ...
            <div className="row">
              <div className="col-lg-5 col-md-6 col-12">
                ...
                <div className="single-footer about">
                  ...
                  <p className="text">
                    Website bán hàng trực tuyến của công ty trách nhiệm hữu hạn
                    hai thành viên, hỗ trợ 24/7 cùng nhiều ưu đẫi hấp dẫn. Luôn
                    luôn cập nhật mới nhiều sản phẩm.
                  </p>
                  <p className="text">
              ...
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer social">
                  ...
                  <div className="contact">
                    <ul>
                      <li>Số 123 P.4,Quận 5,Tp.Hồ Chí Minh </li>
                      <li>Hoai123@tltore.com Khai456@gmail.com </li>
                      <li>+012 3456 7890</li>
                    </ul>
                  </div>
                  {/* End Single Widget */}
